// Vercel Edge Middleware — server-side HTTP Basic Auth, scoped to /interview
// only. The main job posting stays fully public; only the interview deck
// under /interview is gated. Runs on Vercel's Edge before any static file is
// served, so the page is NEVER sent to an unauthenticated visitor.
//
...
export const config = {
  matcher: ['/interview', '/interview/:path*'],
};
